...
public class DcatFactory {
    ...
    public static DcatDataset dataset(CkanDataset dataset, String catalogUrl, Locale locale) {
        ...
        String sanitizedCatalogUrl = TraceProvUtils.removeTrailingSlash(catalogUrl);
        ...
        if (spatialValue == null) {
            ...
            CkanClient.logger.fine("Found attribute 'spatial' in ckan dataset extras, copying value to dct:spatial");
        ...
        if (dataset.getGroups() != null) {
            CkanClient.logger.warning("TODO - USING EMPTY SkosConceptTheme.of() WHILE CONVERTING FROM CKAN TO DCAT DATASET");
    ...
    public static DcatDistribution distribution(CkanResource resource, String catalogURL, String datasetId, String license, Locale locale) {
        ...
        try {
            ...
            CkanClient.logger.log(Level.WARNING, "COULDN'T CONVERT CKAN RESOURCE SIZE TO DCAT! REQUIRED AN INTEGER, FOUND {0} (ALTHOUGH STRINGS ARE VALID CKAN SIZES)", resource.getSize());
        }
