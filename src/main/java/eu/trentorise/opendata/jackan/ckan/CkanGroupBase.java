 ...
 *
 * {@link CkanGroupBase} holds fields that can be sent when
 * <a href="http://docs.ckan.org/en/latest/api/index.html?#ckan.logic.action.create.group_create" target="_blank">creating
 * a group</a>, while {@link CkanGroup} holds more fields that can be returned
 * with searches.
 *
 ...
 * @author David Leoni
 */
public class CkanGroupBase extends CkanGroupOrgBase {

    public CkanGroupBase() {
        super();
     ...
     */
    public CkanGroupBase(String name) {
        super(name);
        setOrganization(false);
    }
}
