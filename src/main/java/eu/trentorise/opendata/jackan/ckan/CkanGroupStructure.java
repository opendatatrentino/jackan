 ...
 * organizations. Since they are different things and work with different
 * apis we made two different implementations. For groups use {@link CkanGroup}
 * and organizations use {@link CkanOrganization} (Ckan way to tell the
